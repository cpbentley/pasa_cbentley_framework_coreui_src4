...
public interface ITechCodes {
   ...
   public static final int  PAD_C_UP                       = 104;

   public static final int  PAD_C_DOWN                     = 105;

   public static final int  PAD_C_LEFT                     = 106;

   public static final int  PAD_C_RIGHT                    = 107;
    ...
    * Point of View Cross
    */
   public static final int  PAD_POV                        = 150;
